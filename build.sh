...
make_pacman_conf() {
echo " Entró por make_pacman_conf() ==============================================="
    local _cache_dirs
...
echo " Entró por make_setup_mkinitcpio() ==============================================="
    local _hook
...
echo " Entró por make_customize_airootfs() ==============================================="
...
make_boot_extra() {
echo " Entró por make_boot_extra() ==============================================="
